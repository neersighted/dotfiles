...
complete -c mongul -s u -l user -x -d 'initial user name'
complete -c mongul -s p -l password -x -d 'initial user password'
complete -c mongul -s d -l db -x -d 'initial db name'
complete -c mongul -s l -l port -x -d 'tcp port'

complete -c mongul -s C -l console -f -d 'open console/cli'
